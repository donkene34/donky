...
<head>
    ...
    <title>{{ config('app.name', 'Donky') }}</title>

    <!-- Scripts -->
    <script src="{{ asset('js/app.js') }}" defer></script>
    <script src="{{ asset('js/uploadVideo.js') }}" defer></script>

    <!-- Fonts -->
    <link rel="dns-prefetch" href="//fonts.gstatic.com">
    <link href="https://fonts.googleapis.com/css?family=NunitoRoboto Condensed" rel="stylesheet">
...
<body>
    ...
    <div id="app">
        ...
        <main class="py-4 mt-5 main display-none">
            @yield('content')
        </main>
    </div>
</body>
